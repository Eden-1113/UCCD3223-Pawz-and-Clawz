...
public class PetListAdapter extends RecyclerView.Adapter<PetListAdapter.PetViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(PetPosts post);
    }


    public PetListAdapter(Context context, List<PetPosts> petList, OnItemClickListener listener) {
    ...
    public PetViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PetViewHolder(view, listener, petList);
    }
    ...
    public static class PetViewHolder extends RecyclerView.ViewHolder {
        TextView txtPetName, txtBreed, txtAge, txtLocation, txtContactNumber;
        ImageView imagePet, imgGenderIcon, imgSpeciesIcon;

        public PetViewHolder(@NonNull View itemView, OnItemClickListener listener, List<PetPosts> petList) {
            super(itemView);
            ...
            imgSpeciesIcon = itemView.findViewById(R.id.imgSpeciesIcon);

            itemView.setOnClickListener(v -> {
                int position = getAdapterPosition();
                if (position != RecyclerView.NO_POSITION && listener != null) {
                    listener.onItemClick(petList.get(position));
                }
            });
        }
    }
